...
<div class="page-wrapper">
	<div class="container-fluid">
		<!-- ipnrm-ui-wrap -->
		<div id="ipnrm-ui-wrap" x-ng-app="ngiPanoramaApp" x-ng-controller="ngiPanoramaAppController">
			<div id="ipnrm-ui-workspace" class="ipnrm-ui-clearfix" x-workspace x-init="appData.fn.workspace.init">
				<div id="ipnrm-ui-header">
					<div class="ipnrm-ui-header-title">iPanorama 360° - Virtual Tour Builder - C:O:D:E:L:I:S:T:.:C:C</div>
				</div>
				...
				<div id="ipnrm-ui-tabs">
					...
					-->
					<div class="ipnrm-ui-tab" x-ng-class="{'ipnrm-ui-active': appData.tabPanel.scenes.isActive}" x-tab-panel-item x-id="scenes" x-init="appData.fn.tabPanelItemInit"><i class="fa fa-fw fa-picture-o"></i>Scenes</div>
					<div class="ipnrm-ui-tab" x-ng-class="{'ipnrm-ui-active': appData.tabPanel.hotspots.isActive, 'ipnrm-ui-hide': !appData.scene.selected}" x-tab-panel-item x-id="hotspots" x-init="appData.fn.tabPanelItemInit"><i class="fa fa-fw fa-dot-circle-o"></i>Hotspots</div>
					<!--
					<div class="ipnrm-ui-cmd-preview" x-ng-click="appData.fn.preview(appData);">Preview</div>
					<div class="ipnrm-ui-cmd-getcode" x-main-menu-item x-id="getcode" x-init="appData.fn.mainMenuItemInit">Get Code</div>
					<div class="ipnrm-ui-cmd-load" x-main-menu-item x-id="load" x-init="appData.fn.mainMenuItemInit">Load Config</div>
					<div class="ipnrm-ui-cmd-save" x-main-menu-item x-id="save" x-init="appData.fn.mainMenuItemInit">Save</div>
					-->
					<div class="ipnrm-ui-cmd-save" x-main-menu-item x-id="getcode" x-init="appData.fn.mainMenuSave">Save</div>
				...
				<div id="ipnrm-ui-tab-data">
										...
										<td class="ipnrm-ui-col-data">
											<div class="ipnrm-ui-control">
												<div class="ipnrm-ui-checkbox">
													...
													<label for="ipnrm-cfg-show-on-hover">Show On Hover</label>
												</div>
											</div>
											...
											<div class="ipnrm-ui-control">
												<div class="ipnrm-ui-radio">
													<input id="ipnrm-cfg-scene-thumbs-vertical-on" type="radio" x-ng-model="appData.config.sceneThumbsVertical" x-ng-value="true">
													<label for="ipnrm-cfg-scene-thumbs-vertical-on">Scene Thumbs Vertical</label>
													<input id="ipnrm-cfg-scene-thumbs-vertical-off" type="radio" x-ng-model="appData.config.sceneThumbsVertical" x-ng-value="false">
											...
											<div class="ipnrm-ui-control">
												<div class="ipnrm-ui-checkbox">
													...
													<label for="ipnrm-cfg-scene-menu-control">Scene Menu Control</label>
												</div>
											</div>
						...
						<div class="ipnrm-ui-config">
							<table class="ipnrm-ui-form-table" x-ng-class="{'ipnrm-ui-hide': !appData.scene.selected}">
								<tbody>
									...
									<tr class="ipnrm-ui-row display-none">
										<td class="ipnrm-ui-col-label">
									...
									<tr class="ipnrm-ui-row">
										...
										<td class="ipnrm-ui-col-data">
											<div class="ipnrm-ui-inline-group">
												<div class="ipnrm-ui-label">Yaw <div class="ipnrm-ui-label-info"><i class="ipnrm-ui-label-btn fa fa-fw fa-arrow-circle-down" x-ng-click="appData.scene.selected.config.yaw=appData.scene.selected.yaw"></i></div></div>
												<div class="ipnrm-ui-control">
											...
											<div class="ipnrm-ui-inline-group">
												<div class="ipnrm-ui-label">Pitch <div class="ipnrm-ui-label-info"><i class="ipnrm-ui-label-btn fa fa-fw fa-arrow-circle-down" x-ng-click="appData.scene.selected.config.pitch=appData.scene.selected.pitch"></i></div></div>
												<div class="ipnrm-ui-control">
											...
											<div class="ipnrm-ui-inline-group">
												<div class="ipnrm-ui-label">Zoom <div class="ipnrm-ui-label-info"><i class="ipnrm-ui-label-btn fa fa-fw fa-arrow-circle-down" x-ng-click="appData.scene.selected.config.zoom=appData.scene.selected.zoom"></i></div></div>
												<div class="ipnrm-ui-control">
									...
									<tr class="ipnrm-ui-row display-none">
										...
										<td class="ipnrm-ui-col-data">
											<div class="ipnrm-ui-inline-group">
												<div class="ipnrm-ui-label"><div class="ipnrm-ui-label-info"><i class="ipnrm-ui-label-btn fa fa-fw fa-arrow-circle-down" x-ng-click="appData.scene.selected.config.compassNorthOffset=appData.scene.selected.yaw"></i></div></div>
												<div class="ipnrm-ui-control">
					...
					<div class="ipnrm-ui-section" x-ng-class="{'ipnrm-ui-active': appData.tabPanel.hotspots.isActive}">
						...
						<div class="ipnrm-ui-config">
							<table class="ipnrm-ui-form-table display-none">
								<tbody>
									<tr class="ipnrm-ui-row">
										<td class="ipnrm-ui-col-label">
										...
										<td class="ipnrm-ui-col-data">
											<div class="ipnrm-ui-control">
												<select x-ng-model="appData.hotspot.selected.config.sceneId">
													...
													<option x-ng-repeat="scene in appData.config.scenes track by scene.id" value=""></option>
												</select>
											</div>
										</td>
									</tr>
			...
			<div id="ipnrm-ui-modal" class="ipnrm-ui-modal" x-ng-class="{'ipnrm-ui-active': appData.modal}" role="dialog">
			...
			<div id="ipnrm-ui-footer">
				<div class="ipnrm-ui-footer-title">© 2016 <a href="http://avirtum.com">AVIRTUM</a>. ALL RIGHTS RESERVED. THE BUILDER VERSION IS </div>
			</div>
			<div class="ipnrm-ui-growl" x-growl></div>
		</div>
		<!-- /end ipnrm-ui-wrap -->
